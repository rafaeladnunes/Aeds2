...
class Palindromo {
   ...
   /**
    * Metodo verifica se uma String e palindromo
    * @param  cadeia String a ser verificada
    * @return        retorno de true or false
    */
   ...
   public static boolean isPalindromo(String cadeia) {
      ...
      for (aux1 = 0 , aux2 = (cadeia.length() - 1); aux1 < cadeia.length() / 2; aux1++, aux2--) {
         if (cadeia.charAt(aux1) != cadeia.charAt(aux2)) {
            resp = false;
         }
      }
      return resp;
