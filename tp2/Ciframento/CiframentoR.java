...
class CiframentoR {
	 ...
	 * @param  i      Contador recebido do metodo executador
	 * @return        Retorna a String cifrada
	 */

	public static String ciframento(String cadeia,int i) {

		String resp = "";

		if(i<cadeia.length()){

			resp += (char)(cadeia.charAt(i)+3) + ciframento(cadeia,++i);
		}
		return resp;
	}

	/**
	 * Metodo chama o ciframento para ser executado e retorna seu resultado
